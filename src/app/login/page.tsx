...
export default function LoginPage() {
  ...
  return <main className={styles.page}>
    ...
    <form className={styles.card} onSubmit={submit}>
      ...
      <div className={styles.options}><label className={styles.remember}><input type="checkbox" />จดจำการเข้าสู่ระบบ</label><button type="button" className={styles.link}>ลืมรหัสผ่าน?</button></div>
